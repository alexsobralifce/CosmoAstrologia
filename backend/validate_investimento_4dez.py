"""
Valida os aspectos reportados para 4 de dezembro de 2025 (ação: investimento).
"""
import sys
import os
...
print("="*80)
print("VALIDAÇÃO DE ASPECTOS - INVESTIMENTO (4 DE DEZEMBRO)")
print("="*80)
print()
...
expected_score = 17  # Vênus sextil Casa 2 (7) + Vênus trígono Casa 8 (10) = 17
