"""
Valida os aspectos reportados para 6 de dezembro de 2025.
...
print("="*80)
print("VALIDAÇÃO DE ASPECTOS - 6 DE DEZEMBRO DE 2025")
print("="*80)
print()
...
for time_str in test_times:
    ...
    # Score esperado baseado no reportado
    expected_score = 28
    expected_aspects = [
    ...
    # Verificar se todos os aspectos esperados foram detectados
