#!/usr/bin/env python3
"""
Script de teste 3 para gerar mapa astral completo com todas as seções.
Dados fictícios: Ana Carolina Ferreira - Mapa com predominância de Fogo
"""
...
# Dados fictícios para teste - Mapa com predominância de Fogo
TEST_DATA = {
    ...
    "language": "pt",
    # Tríade Fundamental - Fogo dominante
    "sunSign": "Áries",
    "moonSign": "Sagitário",
    "ascendant": "Leão",
    "sunHouse": 1,
...
def test_full_birth_chart():
    ...
    print("=" * 80)
    print("🧪 TESTE 3: MAPA ASTRAL COMPLETO - ANA CAROLINA FERREIRA")
    print("=" * 80)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Salvar resultado
            output_file = f"test_birth_chart_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
